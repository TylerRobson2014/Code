	...
	for j in xrange(number_cells):
		for i in xrange(number_cells):
			...
			if count == 0:
				...
				print "off",offset
				lattice_update[array[0][0]][array[0][1]][2] = (lattice[array[1][0]][array[1][1]][2] + offset)%6
				lattice_update[array[1][0]][array[1][1]][2] = (lattice[array[0][0]][array[0][1]][2] + offset)%6
				lattice_update[array[0][0]][array[0][1]][3] = 1
				lattice_update[array[1][0]][array[1][1]][3] = 1
				lattice[array[0][0]][array[0][1]][4] = 0
				lattice[array[1][0]][array[1][1]][4] = 0
			#elif count == 3:
